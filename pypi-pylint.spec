...
Source0  : https://files.pythonhosted.org/packages/62/6d/d671e27077c7d2721266180757c507e68f46403728c6e87eac1b4309c372/pylint-2.15.6.tar.gz
...
%prep
%setup -q -n pylint-2.15.6
cd %{_builddir}/pylint-2.15.6
pushd ..
cp -a pylint-2.15.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669054657
