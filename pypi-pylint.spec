...
Source0  : https://files.pythonhosted.org/packages/17/20/4261712608bce9aba2e502631162920fb60b0da5fbfb1b2f0560314c05ab/pylint-2.13.3.tar.gz
...
%prep
%setup -q -n pylint-2.13.3
cd %{_builddir}/pylint-2.13.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648618083
...
cp %{_builddir}/pylint-2.13.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pylint/909b58c9b803acb8d063ac6b2147e56afc8055f6
