...
Source0  : https://files.pythonhosted.org/packages/68/3a/1e61444eb8276ad962a7f300b6920b7ad391f4fbe551d34443f093a18899/pylint-2.15.9.tar.gz
...
%prep
%setup -q -n pylint-2.15.9
cd %{_builddir}/pylint-2.15.9
pushd ..
cp -a pylint-2.15.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671476338
