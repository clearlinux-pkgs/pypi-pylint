...
Source0  : https://files.pythonhosted.org/packages/8a/d5/e17ebba47b48afd0f58e95858e3ca9bd6615967aefc452f1267fb04a42b8/pylint-2.13.0.tar.gz
...
%prep
%setup -q -n pylint-2.13.0
cd %{_builddir}/pylint-2.13.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648232407
...
cp %{_builddir}/pylint-2.13.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pylint/909b58c9b803acb8d063ac6b2147e56afc8055f6
