...
Source0  : https://files.pythonhosted.org/packages/f5/3d/8296010885be5c42bc2cf4f04287ae11cebdef65d7819984d1be4d1584bd/pylint-2.13.4.tar.gz
...
%prep
%setup -q -n pylint-2.13.4
cd %{_builddir}/pylint-2.13.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648738909
...
cp %{_builddir}/pylint-2.13.4/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pylint/909b58c9b803acb8d063ac6b2147e56afc8055f6
