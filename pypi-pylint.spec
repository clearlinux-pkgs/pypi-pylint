...
Source0  : https://files.pythonhosted.org/packages/9a/e9/60280b14cc1012794120345ce378504cf17409e38cd88f455dc24e0ad6b5/pylint-3.2.3.tar.gz
...
%prep
%setup -q -n pylint-3.2.3
cd %{_builddir}/pylint-3.2.3
pushd ..
cp -a pylint-3.2.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717700836
