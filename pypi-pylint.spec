...
Source0  : https://files.pythonhosted.org/packages/9f/cc/cf24bfbb4591c4cb89cc1d78932874bf75548f837859cd9947587d471c9c/pylint-2.16.4.tar.gz
...
%prep
%setup -q -n pylint-2.16.4
cd %{_builddir}/pylint-2.16.4
pushd ..
cp -a pylint-2.16.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678141164
