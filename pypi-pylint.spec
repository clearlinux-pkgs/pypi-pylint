...
Source0  : https://files.pythonhosted.org/packages/53/8e/ed0cc7e6a96b3367e31b57f5e7510b94c905378a8be3e5657afd9056df44/pylint-2.15.3.tar.gz
...
%prep
%setup -q -n pylint-2.15.3
cd %{_builddir}/pylint-2.15.3
pushd ..
cp -a pylint-2.15.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664206356
