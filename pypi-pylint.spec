...
Source0  : https://files.pythonhosted.org/packages/7b/41/4082d328c959bac11bb4d31ae2aeac96149e66cb3aa630985ac96b123c06/pylint-2.13.2.tar.gz
...
%prep
%setup -q -n pylint-2.13.2
cd %{_builddir}/pylint-2.13.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648416241
...
cp %{_builddir}/pylint-2.13.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pylint/909b58c9b803acb8d063ac6b2147e56afc8055f6
