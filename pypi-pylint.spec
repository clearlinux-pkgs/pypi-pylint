...
Source0  : https://files.pythonhosted.org/packages/76/4e/e0420c7283541d984aa03d48b8758d514ac002a1d08a56e48f16302d6a98/pylint-2.15.0.tar.gz
...
%prep
%setup -q -n pylint-2.15.0
cd %{_builddir}/pylint-2.15.0
pushd ..
cp -a pylint-2.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661880262
