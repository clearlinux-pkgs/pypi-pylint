...
Source0  : https://files.pythonhosted.org/packages/a6/7c/ad5925aa1163b647ad10e81044288c93ef4317c96cd0a3d2b0f0b8059bd7/pylint-2.13.9.tar.gz
...
%prep
%setup -q -n pylint-2.13.9
cd %{_builddir}/pylint-2.13.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652509322
...
cp %{_builddir}/pylint-2.13.9/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pylint/909b58c9b803acb8d063ac6b2147e56afc8055f6
