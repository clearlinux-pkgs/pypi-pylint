...
Source0  : https://files.pythonhosted.org/packages/ab/b9/50be49afc91469f832c4bf12318ab4abe56ee9aa3700a89aad5359ad195f/pylint-3.3.4.tar.gz
...
%prep
%setup -q -n pylint-3.3.4
cd %{_builddir}/pylint-3.3.4
pushd ..
cp -a pylint-3.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738078509
