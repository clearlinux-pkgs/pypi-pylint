...
Source0  : https://files.pythonhosted.org/packages/f8/56/81d13f29c39361c99c307e5b98bd8fc243db10089a16726d7cd80f843726/pylint-2.15.7.tar.gz
...
%prep
%setup -q -n pylint-2.15.7
cd %{_builddir}/pylint-2.15.7
pushd ..
cp -a pylint-2.15.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669823533
