...
Source0  : https://files.pythonhosted.org/packages/96/d2/192ac213f4a61118eacc79efbc7441460b5d5be39e821e2ee282ef6c68a5/pylint-2.16.2.tar.gz
...
%prep
%setup -q -n pylint-2.16.2
cd %{_builddir}/pylint-2.16.2
pushd ..
cp -a pylint-2.16.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1676392645
