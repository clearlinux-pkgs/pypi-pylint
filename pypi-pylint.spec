...
Source0  : https://files.pythonhosted.org/packages/10/ab/f0ad2a4fb3265d71685627db452398f769b48d64d81c7d66ca8c4f4c198b/pylint-3.0.2.tar.gz
...
%prep
%setup -q -n pylint-3.0.2
cd %{_builddir}/pylint-3.0.2
pushd ..
cp -a pylint-3.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698019324
