...
Source0  : https://files.pythonhosted.org/packages/16/4d/c063db1afaa944b0f790348c68a3669d8e8f52ddfff2006a1a85d814e083/pylint-2.16.0.tar.gz
...
%prep
%setup -q -n pylint-2.16.0
cd %{_builddir}/pylint-2.16.0
pushd ..
cp -a pylint-2.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675267652
