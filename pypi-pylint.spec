...
Source0  : https://files.pythonhosted.org/packages/35/1c/4a8135f77a4ec8c0a6dc1d4543dd6fee55b36bb8bf629e2bcce8a94763a9/pylint-3.1.0.tar.gz
...
%prep
%setup -q -n pylint-3.1.0
cd %{_builddir}/pylint-3.1.0
pushd ..
cp -a pylint-3.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708968994
