...
Source0  : https://files.pythonhosted.org/packages/67/8f/79bda74492da08c09016a55942c5fe001fff199b8aaff7a6d82de1012fb4/pylint-2.13.7.tar.gz
...
%prep
%setup -q -n pylint-2.13.7
cd %{_builddir}/pylint-2.13.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650466541
...
cp %{_builddir}/pylint-2.13.7/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pylint/909b58c9b803acb8d063ac6b2147e56afc8055f6
