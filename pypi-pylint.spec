...
Source0  : https://files.pythonhosted.org/packages/bb/f7/2ee3a2959d05a9dd3fba1c72b30e71af3bd86ff37f25b198dd4c41af6b1b/pylint-2.14.1.tar.gz
...
%prep
%setup -q -n pylint-2.14.1
cd %{_builddir}/pylint-2.14.1
pushd ..
cp -a pylint-2.14.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654612297
...
cp %{_builddir}/pylint-2.14.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pylint/909b58c9b803acb8d063ac6b2147e56afc8055f6
