...
Source0  : https://files.pythonhosted.org/packages/30/10/abee071c1d52b2bca48be40fe9f64ca878a77e0beef6504597e8c9c1ed84/pylint-3.2.6.tar.gz
...
%prep
%setup -q -n pylint-3.2.6
cd %{_builddir}/pylint-3.2.6
pushd ..
cp -a pylint-3.2.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721664218
