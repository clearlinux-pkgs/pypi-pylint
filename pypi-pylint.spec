...
Source0  : https://files.pythonhosted.org/packages/87/b6/de7748dac60ff7fa8917f0dc75825ba59f5417053afdafc1d658a6cb4afa/pylint-2.15.4.tar.gz
...
%prep
%setup -q -n pylint-2.15.4
cd %{_builddir}/pylint-2.15.4
pushd ..
cp -a pylint-2.15.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665445575
