...
Source0  : https://files.pythonhosted.org/packages/69/a7/113d02340afb9dcbb0c8b25454e9538cd08f0ebf3e510df4ed916caa1a89/pylint-3.3.6.tar.gz
...
%prep
%setup -q -n pylint-3.3.6
cd %{_builddir}/pylint-3.3.6
pushd ..
cp -a pylint-3.3.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742481074
