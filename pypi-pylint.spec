...
Source0  : https://files.pythonhosted.org/packages/84/c8/6d7d7910699518b5188631bcc4a0dc3c116e0b9d7bbf85183bfc9b7607aa/pylint-2.15.10.tar.gz
...
%prep
%setup -q -n pylint-2.15.10
cd %{_builddir}/pylint-2.15.10
pushd ..
cp -a pylint-2.15.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673283014
