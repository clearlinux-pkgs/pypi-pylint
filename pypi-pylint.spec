...
Source0  : https://files.pythonhosted.org/packages/9c/90/28c6afd89c67ee3338108641f34809e4b8dfc4fd51128c82ff2c46edfc91/pylint-2.14.4.tar.gz
...
%prep
%setup -q -n pylint-2.14.4
cd %{_builddir}/pylint-2.14.4
pushd ..
cp -a pylint-2.14.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656543064
...
cp %{_builddir}/pylint-2.14.4/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pylint/909b58c9b803acb8d063ac6b2147e56afc8055f6
