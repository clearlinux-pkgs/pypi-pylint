...
Source0  : https://files.pythonhosted.org/packages/6d/a5/e36f2f177eaea88101cf54c34aed60401c339c5b2e0708f01f1071839f66/pylint-2.16.1.tar.gz
...
%prep
%setup -q -n pylint-2.16.1
cd %{_builddir}/pylint-2.16.1
pushd ..
cp -a pylint-2.16.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675378090
