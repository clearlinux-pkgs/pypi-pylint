...
Source0  : https://files.pythonhosted.org/packages/3f/66/7ff186ccce07bf2277fcf5ea02485dc4023aefd82023f6d79f8f63376be5/pylint-2.14.0.tar.gz
...
%prep
%setup -q -n pylint-2.14.0
cd %{_builddir}/pylint-2.14.0
pushd ..
cp -a pylint-2.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654186394
...
cp %{_builddir}/pylint-2.14.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pylint/909b58c9b803acb8d063ac6b2147e56afc8055f6
