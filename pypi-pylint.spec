...
Source0  : https://files.pythonhosted.org/packages/aa/b2/e19502f2419ef2da4ac2785da42e77c5bf598a7f2ab59261917f2419b028/pylint-2.13.5.tar.gz
...
%prep
%setup -q -n pylint-2.13.5
cd %{_builddir}/pylint-2.13.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649429774
...
cp %{_builddir}/pylint-2.13.5/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pylint/909b58c9b803acb8d063ac6b2147e56afc8055f6
