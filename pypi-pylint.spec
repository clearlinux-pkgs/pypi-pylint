...
Source0  : https://files.pythonhosted.org/packages/f2/98/c2faadf912f0e234cc29fd60decc43494b63efb766b0aee9abea65ac520f/pylint-2.14.2.tar.gz
...
%prep
%setup -q -n pylint-2.14.2
cd %{_builddir}/pylint-2.14.2
pushd ..
cp -a pylint-2.14.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655314254
...
cp %{_builddir}/pylint-2.14.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pylint/909b58c9b803acb8d063ac6b2147e56afc8055f6
