...
Source0  : https://files.pythonhosted.org/packages/56/5c/6bdcf113646b1dc0459d48e693932e1156376341b74a43ff0a4f79623710/pylint-2.16.3.tar.gz
...
%prep
%setup -q -n pylint-2.16.3
cd %{_builddir}/pylint-2.16.3
pushd ..
cp -a pylint-2.16.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677860894
