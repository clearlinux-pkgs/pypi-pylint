...
Source0  : https://files.pythonhosted.org/packages/cf/e8/d59ce8e54884c9475ed6510685ef4311a10001674c28703b23da30f3b24d/pylint-3.2.7.tar.gz
...
%prep
%setup -q -n pylint-3.2.7
cd %{_builddir}/pylint-3.2.7
pushd ..
cp -a pylint-3.2.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725123381
